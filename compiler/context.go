...
type CompileContext struct {
	...
	Functions    map[string]*CompilerFunction // functions defined in this scope
	Classes      map[string]*CompilerClass    // classes defined in this scope
	Interfaces   map[string]*CompilerInterface // interfaces defined in this scope
	Traits       map[string]*CompilerTrait    // traits defined in this scope
	...
	CurrentClass    *CompilerClass          // currently compiling class (nil if not in class)
	CurrentFunction *CompilerFunction       // currently compiling function (nil if not in function)
}
...
func (ctx *CompileContext) GetFunction(name string) (*CompilerFunction, bool) {
	// Check current context first
...
func (ctx *CompileContext) GetClass(name string) (*CompilerClass, bool) {
	// Check current context first
...
func (ctx *CompileContext) GetInterface(name string) (*CompilerInterface, bool) {
	// Check current context first
...
func (ctx *CompileContext) GetTrait(name string) (*CompilerTrait, bool) {
	// Check current context first
...
func (ctx *CompileContext) SetCurrentClass(class *CompilerClass) {
	ctx.CurrentClass = class
}

// SetCurrentFunction sets the current function being compiled
func (ctx *CompileContext) SetCurrentFunction(function *CompilerFunction) {
...
func (ctx *CompileContext) AddFunction(name string, function *CompilerFunction) {
	ctx.Functions[name] = function
}

// AddClass adds a class to the current context
func (ctx *CompileContext) AddClass(name string, class *CompilerClass) {
	ctx.Classes[name] = class
}

// AddInterface adds an interface to the current context
func (ctx *CompileContext) AddInterface(name string, iface *CompilerInterface) {
	ctx.Interfaces[name] = iface
}

// AddTrait adds a trait to the current context
func (ctx *CompileContext) AddTrait(name string, trait *CompilerTrait) {
