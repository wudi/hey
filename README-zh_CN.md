...
一个用 Go 语言实现的高性能、全面的 PHP 解释器，完全支持 PHP 8 语法。该解析器提供了完整的词法分析、语法解析和 AST 生成功能。
...
- **仓库**: [github.com/wudi/hey](https://github.com/wudi/hey)
- **问题**: [报告错误和功能请求](https://github.com/wudi/hey/issues)
- **文档**: [详细的 API 文档](docs/)
- **示例**: [代码示例和教程](examples/)
