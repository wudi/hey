...
const (
	...
	ASTProgram      ASTKind = 63  // Program root node
	...
	ASTModifierList     ASTKind = 553

	// 0子节点 - 0 child nodes (bits 8-15 = 0)
	ASTMagicConst      ASTKind = 555
	ASTType            ASTKind = 1
	...
	ASTExprStmt                  ASTKind = 522
	ASTFinally                   ASTKind = 523
	ASTGreater                   ASTKind = 524
	ASTGreaterEqual              ASTKind = 525
	ASTAnd                       ASTKind = 526
	ASTOr                        ASTKind = 527
	ASTArrayElem                 ASTKind = 528
	ASTNew                       ASTKind = 529
	ASTInstanceof                ASTKind = 530
	ASTYield                     ASTKind = 531
	ASTCoalesce                  ASTKind = 532
	ASTAssignCoalesce            ASTKind = 533
	ASTStatic                    ASTKind = 534
	ASTWhile                     ASTKind = 535
	ASTDoWhile                   ASTKind = 536
	ASTIfElem                    ASTKind = 537
	ASTSwitch                    ASTKind = 538
	ASTSwitchCase                ASTKind = 539
	ASTDeclare                   ASTKind = 540
	ASTAltIf                     ASTKind = 541
	ASTAltWhile                  ASTKind = 542  
	ASTAltFor                    ASTKind = 543
	ASTAltForeach                ASTKind = 544
	ASTElseIf                    ASTKind = 545
	ASTUseTrait                  ASTKind = 554
	ASTTraitPrecedence           ASTKind = 547
	ASTMethodReference           ASTKind = 548
	ASTNamespace                 ASTKind = 549
	ASTNamespaceName             ASTKind = 550
	ASTUseElem                   ASTKind = 554
	...
	ASTVisibilityModifier ASTKind = 552
